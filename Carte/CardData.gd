...
const DATA = {
	...
	'Phantom':
		['',3, 4, "res://Carte/Sprite Carte/Carta Phantom.png",'He has fangs because he thought it was "edgy", still gets one shotted by almost everything.',"res://Carte/carta.tscn","res://Entity/Unit/Phantom/Phantom.tscn"],
	'Living Armor' :
		['',7, 50, "res://Carte/Sprite Carte/Carta Bullone.png",'The real deal, the Boss among the army of useless undead, the best tank, the best frontline and the best unti among them, except he takes double the emotional damage because his head is small. Do not make fun of his name, he is sensitive about the topic...',"res://Carte/carta.tscn","res://Entity/Unit/Living Wisp/Living_Wisp.tscn"],
	'Sorcerer':
		['',3, 5, "res://Carte/Sprite Carte/Carta Sorcerer.png",'Meant to be the main character, born to be a stupid minion..., literally.',"res://Carte/carta.tscn","res://Entity/Unit/Mage Skeleton/Mage Skeleton.tscn"],
	'Heal' :
